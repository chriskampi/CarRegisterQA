...
from values_data.car_registration_applications import invalid_car_registration_too_many_numbers
...
class TestInvalidCarRegistrationTooManyNumbers:
    ...
    CAR_REGISTRATION = invalid_car_registration_too_many_numbers()
