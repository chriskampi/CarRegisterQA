...
from values_data.car_registration_applications import invalid_car_registration_romanian_pattern
...
class TestInvalidCarRegistrationTooManyNumbers:
    ...
    CAR_REGISTRATION = invalid_car_registration_romanian_pattern()
